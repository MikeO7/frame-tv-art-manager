...
services:
  frame-tv-art-manager:
    ...
    environment:
      ...
      # SMART_CROP_ENABLED: "true" (Default: true)
      # Non-16:9 images are intelligently cropped to fill the full 16:9 screen.
...
| `MAX_ARTWORK_IMAGES` | `100` | Maximum images allowed in the artwork folder (0=unlimited) |
...
|---|---|---|
| `UNSPLASH_APP_ID` | *(unset)* | Unsplash — Application ID |
| `UNSPLASH_ACCESS_KEY` | *(unset)* | Unsplash — Access Key |
| `UNSPLASH_SECRET_KEY` | *(unset)* | Unsplash — Secret Key |
...
It is free to use, modify, and share for **personal and non-commercial purposes**. Commercial use (e.g., selling the software or charging for it as a service) is strictly prohibited. See the [LICENSE](LICENSE) file for the full legal text.
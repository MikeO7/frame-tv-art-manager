...
func TestLoadDefaultContract(t *testing.T) {
	...
	want := &Config{
		...
		SharpenAmount:                  0.25,
		SharpenThreshold:               4,
		ColorProfilePolicy:             "convert-srgb",
		HDRToneMap:                     true,
		HDRSourcePeakNits:              1000,
		HDRTargetPeakNits:              100,
		PerceptualDuplicates:           true,
...
func TestLoadEveryEnvironmentValueContract(t *testing.T) {
	...
	values := map[string]string{
		...
		"SMART_CROP_MIN_GAIN":            "0.08",
		"SMART_CROP_PROTECTION":          contractFalse,
		"SMART_CROP_PROTECTION_STRENGTH": "0.6",
		"SMART_CROP_PROVIDER":            "http", "SMART_CROP_PROVIDER_URL": "https://crop.example.test/v1",
		"SMART_CROP_PROVIDER_MIN_CONFIDENCE": "0.8", "SMART_CROP_PROVIDER_TIMEOUT_SECONDS": "12",
		"IMAGE_MAX_WIDTH": "1920", "IMAGE_MAX_HEIGHT": "1080",
		"IMAGE_MAX_OUTPUT_PIXELS": "10000000", "IMAGE_MAX_WORKING_MEMORY_MB": "768",
		"IMAGE_JPEG_QUALITY": "88",
		"IMAGE_OPTIMIZE_PNG": contractFalse, "IMAGE_LINEAR_LIGHT_RESIZE": contractFalse,
		"IMAGE_SHARPEN_AMOUNT":       "0.4",
		"IMAGE_SHARPEN_THRESHOLD":    "6",
		"IMAGE_COLOR_PROFILE_POLICY": "reject-embedded", "IMAGE_MUSEUM_MODE": contractTrue,
		"IMAGE_HDR_TONE_MAP": contractFalse, "IMAGE_HDR_SOURCE_PEAK_NITS": "2000", "IMAGE_HDR_TARGET_PEAK_NITS": "120",
		"IMAGE_PERCEPTUAL_DUPLICATES": contractFalse, "IMAGE_PERCEPTUAL_DUPLICATE_DISTANCE": "9",
	...
	want := &Config{
		...
		SmartCropMinGain:               0.08,
		SmartCropProtection:            false,
		SmartCropProtectionStrength:    0.6,
		SmartCropProvider:              "http",
		SmartCropProviderURL:           "https://crop.example.test/v1",
		SmartCropProviderMinConfidence: 0.8,
		SmartCropProviderTimeout:       12 * time.Second,
		OptimizeMaxWidth:               1920,
		OptimizeMaxHeight:              1080,
		OptimizeMaxPixels:              10_000_000,
		OptimizeMemoryMB:               768,
		OptimizeJPEGQuality:            88,
		OptimizePNG:                    false,
		LinearLightResize:              false,
		SharpenAmount:                  0.4,
		SharpenThreshold:               6,
		ColorProfilePolicy:             "reject-embedded",
		HDRToneMap:                     false,
		HDRSourcePeakNits:              2000,
		HDRTargetPeakNits:              120,
		PerceptualDuplicates:           false,
		PerceptualDuplicateDistance:    9,

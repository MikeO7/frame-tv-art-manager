...
func TestConvergenceStatusProjectionIsExhaustive(t *testing.T) {
	...
	errorCases := []struct {
		...
		{name: "recorded storage full", status: reconcile.StatusStorageFull, wantStatus: statusStorageFull, storageFull: true},
		...
		{name: "storage", hasError: true, samsungKind: samsung.ErrorKindStorageFull, wantStatus: statusStorageFull, storageFull: true},
	...
	summaryCases := []struct {
		...
		{name: "storage full", status: reconcile.StatusStorageFull, want: statusStorageFull},

...
func (s *TVReconciler) ExecuteSyncPlan(
	...
	s.executeDeletes(ctx, plan, transport, mapping, policy, &result)
...
//nolint:revive // justified argument count for pure execution logic
...
//nolint:revive // justified argument count for pure execution logic
func (s *TVReconciler) executeDeletes(
	ctx context.Context,
	plan *SyncPlan,
	transport TVTransport,
	mapping *Mapping,
